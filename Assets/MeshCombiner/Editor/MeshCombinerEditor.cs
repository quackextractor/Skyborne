...
namespace MeshCombiner.Editor
{
	[CustomEditor(typeof(Scripts.MeshCombiner))]
	public class MeshCombinerEditor : UnityEditor.Editor
	{
		public override void OnInspectorGUI()
		{
			var meshCombiner = (Scripts.MeshCombiner)target;
			var mesh = meshCombiner.GetComponent<MeshFilter>().sharedMesh;

			#region Script:
			GUI.enabled = false;
			EditorGUILayout.ObjectField("Script", MonoScript.FromMonoBehaviour((Scripts.MeshCombiner)target), typeof(Scripts.MeshCombiner), false);
			GUI.enabled = true;
			#endregion Script.
