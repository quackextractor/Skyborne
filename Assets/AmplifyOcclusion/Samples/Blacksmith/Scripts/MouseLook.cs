...
namespace AmplifyOcclusion.Samples.Blacksmith.Scripts
{
	public class MouseLook : MonoBehaviour
	{
		...
		void Update ()
		{
			...
			var scale = ( Input.GetKey( KeyCode.LeftShift ) || Input.GetKey( KeyCode.RightShift ) ) ? 150.0f : 50.0f;
			var forwardSpeed = Input.GetAxis( "Vertical" ) * forwardSpeedScale * scale;
			var strafeSpeed = Input.GetAxis( "Horizontal" ) * strafeSpeedScale * scale;
